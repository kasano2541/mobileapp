...
class _MyHomePage4State extends State<MyHomePage5> {
  ...
  _takePhoto() async {
    setState(() {
      fileImage = ImagePicker.pickVideo(source: ImageSource.camera);
    });
  }

  _selectGalleryImage() async {
    setState(() {
      fileImage = ImagePicker.pickVideo(source: ImageSource.gallery);
    });
  }
