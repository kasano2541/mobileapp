...
class _ProfileFirstState extends State<ProfileFirst> {
  TextEditingController nameTag = TextEditingController();

//  void NameTag() {
//    Map<String, String> params = Map();
//    params['nameTag'] = nameTag.text;
//    http.post('${Config.API_URL}/user/list', body: params).then((res) {
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          Text(nameTag.text, style: TextStyle(
                              color: Colors.white,
