//_____CodeFrom = https://www.youtube.com/watch?v=gQnwh2-2xRs&fbclid=IwAR0rJDPLvt48ARAOe4mZAdA5dARDiOOs2KSHzpL3s69f5YcXZ_E47QMFk8A
...
class _MyHomePageState extends State<MyHomePage2> {
  ...
  static const baseUrl = 'http://192.168.137.1';
  ...
  _uploadImage() async {
    ...
    try {
      final url = Uri.parse('$baseUrl/store/upload.php');
